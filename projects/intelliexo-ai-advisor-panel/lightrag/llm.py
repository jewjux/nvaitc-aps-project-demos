...
async def openai_complete_if_cache(
    ...
    **kwargs,
    ...
    openai_async_client = (
        AsyncOpenAI() if base_url is None else AsyncOpenAI(base_url=base_url, api_key=os.getenv('NVIDIA_API_KEY'))
    )
...
async def nvidia_openai_complete(
    ...
    result = await openai_complete_if_cache(
        "nvdev/meta/llama-3.1-70b-instruct",  # context length 128k
        # "nvdev/deepseek-ai/deepseek-r1", # nvdev/mistralai/mixtral-8x7b-instruct-v0.1
        prompt,
        system_prompt=system_prompt,
        history_messages=history_messages,
